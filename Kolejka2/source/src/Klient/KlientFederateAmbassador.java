 ...
 * {@link KlientFederate}. It will log information about any callbacks it
...
public class KlientFederateAmbassador extends NullFederateAmbassador
{
    ...
    public KlientFederateAmbassador(KlientFederate federate )
    {
            ...
            throws FederateInternalError
    {
        ...
        for( AttributeHandle attributeHandle : theAttributes.keySet() )
        {
            ...
            if( attributeHandle.equals(federate.stolikAvailableHandle) )
            {
                builder.append( attributeHandle );
                ...
                federate.stolikAvaiable = available.getValue();
            }
            else if(attributeHandle.equals(federate.nrStolikaHandle)){
                builder.append( attributeHandle );
                builder.append( " (NrStolika)    " );
                builder.append( ", attributeValue=" );
                HLAinteger32BE nr_stolika = new HLA1516eInteger32BE();
                try{
                    nr_stolika.decode(theAttributes.get(attributeHandle));
                } catch (DecoderException e){
                    e.printStackTrace();
                }
                builder.append(nr_stolika.getValue());
                federate.nr_zajetego = nr_stolika.getValue();
            }
            else
            {
                builder.append( attributeHandle );
