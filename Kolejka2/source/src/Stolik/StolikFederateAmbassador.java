...
public class StolikFederateAmbassador extends NullFederateAmbassador
{
            ...
            throws FederateInternalError
    {
        ...
        if( interactionClass.equals(federate.zajmijStolikHandle) )
        {
            ...
            byte[] bytes2 = theParameters.get(federate.idKlientaZajmijHandle);
            ...
            Stolik.getInstance().zajmij_stolik(1, id_klienta.getValue());
        }
        else if( interactionClass.equals(federate.zwolnijStolikHandle) )
        {
            byte[] bytes2 = theParameters.get(federate.idKlientaZwolnijHandle);
            //HLAinteger16BE nr_stolika = new HLA1516eInteger16BE();
            HLAinteger32BE id_klienta = new HLA1516eInteger32BE();
            try {
                //nr_stolika.decode(bytes2);
            ...
            Stolik.getInstance().zwolnij_stolik(1, id_klienta.getValue());
